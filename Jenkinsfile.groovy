...
node {
	...
	def applicationName = 'mean' //change me
	def deploymentGroupName = 'mean' // change me
	...
	stage("Sonar Analyze") {
	    ...
	    withSonarQubeEnv('default') {
	      sh "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=${deploymentGroupName} -Dsonar.sources=."
	    }
	}
